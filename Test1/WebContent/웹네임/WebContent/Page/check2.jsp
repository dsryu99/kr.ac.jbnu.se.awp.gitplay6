...
%>
 <div class="result">
 <h1><p style="text-align: center;"><% out.println("두번째 검사 결과는 " + result2 + "입니다." ); %></p></h1>
 <a href="check3.html"><p style="text-align: center;"><button type="button" >다음 검사하기</button></p></a>
 </div>
</main>
</body>
</html>
